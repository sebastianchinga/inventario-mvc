        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Creando servicio</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container-fluid">
                    <a href="/servicios" class="btn btn-danger mb-3">Volver</a>
                    <?php include __DIR__ . '/../templates/alertas.php' ?>
                    <form method="post">
                        <?php include __DIR__ . '/formulario.php' ?>
                        <input type="submit" value="Actualizar servicio" class="btn btn-primary btn-block">
                    </form>
                </div><!-- /.container-fluid -->
            </div>
            <!-- /.content -->
