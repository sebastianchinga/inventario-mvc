        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <form id="quickForm" method="post" action="/empresas/crear">

                        <?php include __DIR__ . '/formulario.php' ?>

                        <div class="form-group mb-3">
                            <input type="submit" value="Guardar empresa" class="btn btn-primary btn-block">
                        </div>
                    </form>
                </div><!-- /.container-fluid -->
            </div>
