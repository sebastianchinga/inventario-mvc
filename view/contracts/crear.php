<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="container-fluid">
                    <a href="/contratos" class="btn btn-danger mb-3">Volver</a>
                    <?php include __DIR__ . '/../templates/alertas.php' ?>
                    <form id="quickForm" method="post" action="/contratos/crear">

                        <?php include __DIR__ . '/formulario.php' ?>

                        <div class="form-group mb-3">
                            <input type="submit" value="Guardar contrato" class="btn btn-primary btn-block">
                        </div>
